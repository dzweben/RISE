...
3. Run a Regression with Age, Sex (control), CARROT, reward_comp_mean, bdi, mid_govslo_ho_accumbens_50prob,  (IVs)
...
# Define the regression model with the updated IVs and DV
model <- lm(SSM_composite ~ DD_IndiffAvg + CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + BDI_TOT, data = df1)
...
model_tidy <- model_tidy %>%
  mutate(term = recode(term,
                       ...
                       "BDI_TOT" = "Depression Symptoms")) %>%
  arrange(factor(term, levels = c("Constant", "Age", "Sex","DD", "Carrot", "Reward_SelfReport", "Depression Symptoms", "MID_GVL_NACC")))
...
4. Run a Regression with Age, Sex (control), CARROT, reward_comp_mean, bdi, mid_govslo_ofc_8mmsphere_ng,  (IVs)
...
# Define the regression model with the updated IVs and DV
model <- lm(SSM_composite ~ DD_IndiffAvg + CARROT + reward_comp_mean + Age + Sex + mid_govslo_ofc_8mmsphere_ng + BDI_TOT, data = df1)
...
model_tidy <- model_tidy %>%
  mutate(term = recode(term,
                       ...
                       "BDI_TOT" = "Depression Symptoms")) %>%
  arrange(factor(term, levels = c("Constant", "Age", "Sex","DD", "Carrot", "Reward_SelfReport", "Depression Symptoms", "MID_GVL_OFC")))
...
# Define the regression model with the updated IVs and DV
model <- lm(SSM_composite ~ Age + Sex + mid_govslo_ofc_8mmsphere_ng , data = df1)
...
3. Run a Regression with Age, Sex (control), CARROT, reward_comp_mean, BDI  (IVs), mid_govslo_ho_accumbens_50prob
...
# Define the regression model with the updated IVs and DV
model <- lm(SSM_subjective ~ DD_IndiffAvg + CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + BDI_TOT, data = df1)
...
print(regression_table)
```
4. Run a Regression with Age, Sex (control), CARROT, reward_comp_mean, BDI  (IVs), mid_govslo_ofc_8mmsphere_ng
```{r}
...
# Define the regression model with the updated IVs and DV
model <- lm(SSM_subjective ~ DD_IndiffAvg + CARROT + reward_comp_mean + Age + Sex + mid_govslo_ofc_8mmsphere_ng + BDI_TOT, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(SSM_subjective ~ Age + Sex+ mid_govslo_ho_accumbens_50prob, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(OBJ_DAILY ~ DD_IndiffAvg + CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + BDI_TOT, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(OBJ_DAILY ~ DD_IndiffAvg + CARROT + reward_comp_mean + Age + Sex + mid_govslo_ofc_8mmsphere_ng + BDI_TOT, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(OBJ_DAILY ~ Age + Sex  + mid_govslo_ofc_8mmsphere_ng , data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Digital_awareness~ DD_IndiffAvg + CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + BDI_TOT, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Digital_awareness~ DD_IndiffAvg + CARROT + reward_comp_mean + Age + Sex + mid_govslo_ofc_8mmsphere_ng + BDI_TOT, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Digital_awareness~ Age + Sex + mid_govslo_ho_accumbens_50prob, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Digital_overestimation~ DD_IndiffAvg + CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + BDI_TOT, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Digital_overestimation~ DD_IndiffAvg + CARROT + reward_comp_mean + Age + Sex + mid_govslo_ofc_8mmsphere_ng + BDI_TOT, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Digital_overestimation~ Age + Sex + mid_govslo_ho_accumbens_50prob , data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Subjective_daily~ DD_IndiffAvg + CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + BDI_TOT, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Subjective_daily~ DD_IndiffAvg + CARROT + reward_comp_mean + Age + Sex + mid_govslo_ofc_8mmsphere_ng + BDI_TOT, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Subjective_daily~ Age + Sex  + mid_govslo_ho_accumbens_50prob , data = df1)
...
selected_vars <- subset(df1, select = c(
  ...
  Digital_awareness, mid_govslo_ho_accumbens_50prob, mid_govslo_ofc_8mmsphere_ng, 
...
row_labels <- c(
  ...
  "11. Digital Awareness", "12. MID GVL NACC", "13. MID GVL OFC", 
