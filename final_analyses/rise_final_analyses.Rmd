...
df1 <- df1 <- fulldataset[, c("rise_id","DD_IndiffAvg", "CARROT", "BAS_TOT", "reward_comp_mean", "BDI_TOT", 
                       "Age", "Sex", "MTES_TOT", "SAS", "OBJ_DAILY", "SSM_composite", 
                       "SSM_subjective", "Digital_overestimation", "Digital_awareness", 
                       "mid_govslo_ho_accumbens_50prob", "mid_govslo_ofc_8mmsphere_ng", "Subjective_daily", "MTES_TOT")]
...
model <- lm(SSM_composite ~ CARROT + reward_comp_mean + Age + Sex, data = df1)
...
model <- lm(SSM_composite ~ CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + mid_govslo_ofc_8mmsphere_ng, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(SSM_composite ~ CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + mid_govslo_ofc_8mmsphere_ng + BDI_TOT, data = df1)
...
# Define the regression model
model <- lm(SSM_subjective ~ CARROT + reward_comp_mean + Age + Sex, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(SSM_subjective ~ CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + mid_govslo_ofc_8mmsphere_ng, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(SSM_subjective ~ CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + mid_govslo_ofc_8mmsphere_ng + BDI_TOT, data = df1)
...
# Define the regression model
model <- lm(OBJ_DAILY ~ CARROT + reward_comp_mean + Age + Sex, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(OBJ_DAILY ~ CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + mid_govslo_ofc_8mmsphere_ng, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(OBJ_DAILY ~ CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + mid_govslo_ofc_8mmsphere_ng + BDI_TOT, data = df1)
...
# Define the regression model
model <- lm(Digital_awareness ~ CARROT + reward_comp_mean + Age + Sex, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Digital_awareness ~ CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + mid_govslo_ofc_8mmsphere_ng, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Digital_awareness ~ CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + mid_govslo_ofc_8mmsphere_ng + BDI_TOT, data = df1)
...
# Define the regression model
model <- lm(Digital_overestimation ~ CARROT + reward_comp_mean + Age + Sex, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Digital_overestimation ~ CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + mid_govslo_ofc_8mmsphere_ng, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Digital_overestimation ~ CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + mid_govslo_ofc_8mmsphere_ng + BDI_TOT, data = df1)
...
# Define the regression model
model <- lm(Subjective_daily ~ CARROT + reward_comp_mean + Age + Sex, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Subjective_daily ~ CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + mid_govslo_ofc_8mmsphere_ng, data = df1)
...
# Define the regression model with the updated IVs and DV
model <- lm(Subjective_daily ~ CARROT + reward_comp_mean + Age + Sex + mid_govslo_ho_accumbens_50prob + mid_govslo_ofc_8mmsphere_ng + BDI_TOT, data = df1)
